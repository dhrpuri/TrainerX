...
* Stopwatch is service which will ask for the system for permission to open Secondary app on top of base app.
* The stopwatch is  floating and can be dragged wherever user need.
* Stopwatch data is not persisted but used as alternative to other application or physical stopwatch.
* Stopwatch is made available to all screens by the button on top right.
*
*
* */
@TargetApi(23)
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        int x_diff = initialX - (int) initialTouchX;
                        int y_diff = initialY - (int) initialTouchY;
