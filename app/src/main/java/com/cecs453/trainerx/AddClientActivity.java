...
/*
 * Created : Pratik and Sourabh
 * Implementation of adding Client.
 * The trainer Id is persisited as Creator Id where we can set the access for the particular trainer for sppecific clients..
 *
 *
 * */
...
public class AddClientActivity extends AppCompatActivity {
    ...
    /*
    * Created: Pratik and sourabh
    * Method persist client infrmation to database. Have kept first name and last name as compulsory field.
    * Image is optional for the current release.
    *
    * */
    ...
    private void uploadData() {
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        clientTemp.setfName(editTextFirstName.getText().toString());
                        clientTemp.setlName(editTextLastName.getText().toString());
                        clientTemp.setImageURL(task.getResult().toString());
                        ...
                        db.collection("customers")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    ...
                                    public void onSuccess(DocumentReference documentReference) {
                                        ...
                                        clientTemp.setDocId(documentReference.getId());
                                        Intent intent=new Intent();
                                        Bundle b = new Bundle();
                                        b.putSerializable("client", clientTemp);
                                        intent.putExtra("client", b);
        ...
        Toast.makeText(this,"Saved Client",Toast.LENGTH_SHORT).show();
    }
