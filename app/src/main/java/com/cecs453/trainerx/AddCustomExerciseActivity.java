...
* @created: Sourabh
*
* This activity add the custom exercise to the list of available excersise.
* User can select the type from the list of available types.
* On save the list is updated dinamyc
* */
        ...
        db.collection("exercises")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        Bundle b = new Bundle();
                        b.putSerializable("ex", exercise);
                        intent.putExtra("ex", b);
